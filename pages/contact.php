    ...
    <header class="container-fluid" style="margin-top: 106px;">
        <div class="row" style="height: 300px;">
            <div
                ...
                <img class="w-100 position-absolute" style="min-height: 100%;" src="../images/bg-contact.webp"
            ...
            <div class="col-12 col-lg-6 bg-success d-flex flex-column justify-content-center pb-5 pt-4 px-2">
                ...
                <div class="col-12">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input name="email" maxlength="255" type="email" class="form-control"
                            placeholder="durantolivier@gmail.com"
                            aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback" required>
                    </div>
                </div>
                <div class="col-12">
                    <label for="validationServer02" class="form-label">Message</label>
                    <input name="msg" maxlength="255" type="text" class="form-control"
